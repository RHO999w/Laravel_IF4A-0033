...
@section('title', 'Tambah Berita — Kabar Burung')
...
<div class="container">
    <div class="kb-form-wrap">
        <h1 class="kb-form-title kb-display">Tambah Berita</h1>

        <form method="POST" action="{{ route('posts.store') }}">
            @csrf
            @include('posts._form')

            <button type="submit" class="kb-btn-primary">Simpan Berita</button>
        </form>
    </div>
</div>
